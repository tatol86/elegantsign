...
CREATE TABLE "Product" (
    ...
    "leadTimeDays" TEXT NOT NULL,
    "buildStyle" TEXT,
    "shape" TEXT,
    "mountingOptions" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateIndex
CREATE INDEX "Product_buildStyle_idx" ON "Product"("buildStyle");
...
-- CreateIndex
CREATE INDEX "ProductSizeOption_productId_sortOrder_idx" ON "ProductSizeOption"("productId", "sortOrder");
