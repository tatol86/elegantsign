        ...
        <div className="min-h-screen bg-neutral-950 text-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between mb-6">
                    <div>
                        <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">Catalog</p>
                        <h1 className="text-4xl font-bold tracking-tight mt-2">Product Management</h1>
                        <p className="text-neutral-400 mt-2">Create, edit, and remove products from your storefront.</p>
                    </div>
                    <button
                        onClick={() => { setIsCreating(true); setEditingProduct(null); }}
                        className="flex items-center gap-2 px-5 py-3 bg-white text-black font-semibold rounded-xl hover:bg-neutral-200 transition-colors text-sm w-full lg:w-auto justify-center"
                    >
        ...
        <div className="min-h-screen bg-neutral-950 text-white">
            ...
            <div className="max-w-4xl mx-auto px-6 py-8 space-y-10">
                ...
                <div className={sectionClass}>
                    ...
                    <p className="text-xs text-neutral-600">Supported formats: JPEG, PNG, WebP, AVIF. When `BLOB_READ_WRITE_TOKEN` is configured, uploads go to Vercel Blob. Otherwise local development falls back to `/public/products/uploads/`.</p>
                </div>
            </div>
        </div>
    );
